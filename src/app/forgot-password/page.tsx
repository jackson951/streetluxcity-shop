...
export default function ForgotPasswordPage() {
  ...
  async function handleEmailSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/verify-otp?flow=forgot-password&email=${encodeURIComponent(email)}`);
      ...
      <div className="mb-6 sm:mb-8 text-center">
        ...
        {view === "email" && (
          <>
            ...
            <p className="mt-2 text-sm text-slate-500">Enter your email to receive a verification code.</p>
          </>
        )}
        ...
        {view === "success" && (
          <>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Password updated! 🎉</h1>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-7 shadow-sm sm:shadow-md relative">
        ...
        {view === "reset" && (
          <form onSubmit={handlePasswordReset} className="space-y-4" noValidate>
            ...
            <Field label="Confirm new password" error={formErrors.confirmPassword}>
              <div className="relative">
                <input
                  className={`${inputClass} pr-11`}
      ...
      {view !== "success" && (
        <>
          ...
          <p className="mt-6 text-center text-xs text-slate-400">
            Need help?{" "}
            <Link href="/support" className="underline hover:text-slate-600">Contact support</Link>
          </p>
        </>
      )}
